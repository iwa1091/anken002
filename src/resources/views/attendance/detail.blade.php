    ...
    @else
        ...
        <form action="{{ route('application.storeCorrectionRequest', ['attendance_id' => $attendance->id]) }}" method="POST" class="correction-form">
            ...
            <div class="form-group">
                <label for="type" class="form-label">修正の種類</label>
                <select id="type" name="type" class="form-control">
                    <option value="">選択してください</option>
                    <option value="打刻ミス" {{ old('type') == '打刻ミス' ? 'selected' : '' }}>打刻ミス</option>
                    <option value="休憩時間修正" {{ old('type') == '休憩時間修正' ? 'selected' : '' }}>休憩時間修正</option>
                    <option value="出勤日修正" {{ old('type') == '出勤日修正' ? 'selected' : '' }}>出勤日修正</option>
                    <option value="退勤日修正" {{ old('type') == '退勤日修正' ? 'selected' : '' }}>退勤日修正</option>
